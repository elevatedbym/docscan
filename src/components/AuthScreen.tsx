  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 flex flex-col items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm">
        ...
        {/* Staticke zastave - bez klika */}
        <div className="flex justify-center gap-8 mt-8">
          <span className="text-4xl" title="Srpski">🇷🇸</span>
          <span className="text-4xl" title="Hrvatski">🇭🇷</span>
          <span className="text-4xl" title="Bosanski">🇧🇦</span>
        </div>
      </div>
    </div>
  );
